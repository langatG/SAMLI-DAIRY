...
Begin VB.Form frmSupplies 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cboBBranch 
         Height          =   315
         ItemData        =   "frmSupplies.frx":01D2
         Left            =   2400
         List            =   "frmSupplies.frx":01D4
         TabIndex        =   21
         Top             =   1920
         Width           =   4695
      End
      Begin VB.ComboBox cboBankName 
         Height          =   315
         ItemData        =   "frmSupplies.frx":01D6
         Left            =   2400
         List            =   "frmSupplies.frx":01D8
         TabIndex        =   19
         Top             =   600
         Width           =   4695
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbocontcode 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmSupplies.frx":01DA
         Left            =   8160
         List            =   "frmSupplies.frx":01EA
         TabIndex        =   92
         Top             =   3960
         Visible         =   0   'False
         Width           =   1695
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cbostatus 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmSupplies.frx":04D3
            Left            =   10800
            List            =   "frmSupplies.frx":04E9
            Locked          =   -1  'True
            TabIndex        =   82
            Text            =   "New"
            Top             =   720
      ...
      Begin VB.ComboBox cbobrnch 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "frmSupplies.frx":07E3
         Left            =   2400
         List            =   "frmSupplies.frx":07E5
         TabIndex        =   7
         Top             =   4200
         Width           =   3255
      End
      ...
      Begin VB.ComboBox cboTCode 
         Height          =   315
         ItemData        =   "frmSupplies.frx":07E7
         Left            =   8160
         List            =   "frmSupplies.frx":07F1
         TabIndex        =   14
         Top             =   3000
         Width           =   1815
      End
      ...
      Begin VB.ComboBox cboType 
         Height          =   315
         ItemData        =   "frmSupplies.frx":146E
         Left            =   7920
         List            =   "frmSupplies.frx":147B
         TabIndex        =   16
         Top             =   3480
         Width           =   1935
      End
